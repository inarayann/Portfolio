 ...
 * 
 * Creates animated 3D ASCII text using Three.js
...
class CanvasTxt {
  ...
  resize() {
    if (this.context) {
      ...
      // Use actualBoundingBoxRight if available for more accurate width, otherwise use width + extra padding
      const measuredWidth = metrics.actualBoundingBoxRight !== undefined 
        ? metrics.actualBoundingBoxRight 
        : metrics.width;
      
      // Add extra padding to ensure last letter isn't cut off
      const textWidth = Math.ceil(measuredWidth) + 40; // Increased from 20 to 40
  ...
  render() {
    if (this.context) {
      ...
      // Ensure text starts with enough padding and doesn't get cut off
      this.context.fillText(this.txt, 10, yPos);
      
      // Optional: Uncomment to debug canvas size vs text width
      // console.log('Canvas width:', this.canvas.width, 'Text width:', metrics.width, 'Actual bounding right:', metrics.actualBoundingBoxRight);
    }
  }
